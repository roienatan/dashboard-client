...
export default function Search(props) {
    return <svg fill={props.fill} width={props.width} viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" id="Icons_MagnifyingGlass" overflow="hidden">
